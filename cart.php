...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .dropdown-menu {
            position: absolute; top: 100%; right: 0; background: #0b0b0b; border-radius: 8px; padding: 8px 0; min-width: 180px;
            box-shadow: 0 8px 25px rgba(0,0,0,0.3); opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.3s ease; z-index: 1000;
        }
        .profile-dropdown:hover .dropdown-menu { opacity: 1; visibility: visible; transform: translateY(0); }
        .dropdown-menu a { display: block; padding: 10px 16px; color: #fff; font-size: 14px; transition: background 0.2s ease; }
        .dropdown-menu a:hover { background: rgba(255,255,255,0.1); }
        .dropdown-divider { height: 1px; background: rgba(255,255,255,0.2); margin: 6px 0; }

        /* User Welcome in Navigation */
        .user-welcome {
            color: #fff; font-size: 14px; display: flex; align-items: center; gap: 8px; padding: 8px 12px;
            background: rgba(255,255,255,0.1); border-radius: 8px; margin-left: 8px;
        }
        ...
        .topline { display:flex; align-items:center; gap:12px; margin-bottom:8px; }
        .back-btn { background:#fff; border:0; padding:8px 10px; border-radius:8px; cursor:pointer; font-weight:700; }
        h1 { margin:0; }
        ...
        .cart-item {
            background:#fff; padding:18px; border-radius:12px; border:1px solid #eee; display:flex; gap:18px;
            align-items:flex-start; margin-bottom:12px;
        }
        
        .thumb { width:120px; height:150px; border-radius:8px; background:#f0f0f0; flex-shrink:0; overflow:hidden; }
        .thumb img { width:100%; height:100%; object-fit:cover; }
        
        .item-details { flex:1; }
        .title { font-weight:700; font-size:16px; margin-bottom:8px; }
        .meta { font-size:14px; color:var(--muted); margin-bottom:8px; }
        .rental-period { background:#f8f9fa; padding:8px 12px; border-radius:6px; font-size:14px; margin-bottom:12px; display:inline-block; }
        
        .item-actions { display:flex; align-items:center; gap:12px; margin-top:12px; }
        
        .summary {
            background:#fff; padding:24px; border-radius:12px; border:1px solid #eee; height:fit-content;
            position:sticky; top:100px;
        }
        .summary-title { font-weight:800; font-size:18px; margin-bottom:16px; padding-bottom:12px; border-bottom:1px solid #eee; }
        .summary-row { display:flex; justify-content:space-between; margin-bottom:12px; font-size:14px; }
        .total-row { display:flex; justify-content:space-between; font-weight:800; margin-top:16px; padding-top:16px; border-top:1px solid #eee; font-size:16px; }
        ...
        .btn.black { background:var(--accent); color:#fff; border:1px solid var(--accent); }
        .btn.black:hover { background:#333; border-color:#333; }
        .btn.wishlist {
            background:#fff; color:#1f1d1dff; border:1px solid #22201fff; display:flex; align-items:center;
            gap:6px; padding:8px 12px;
        }
        .btn.wishlist:hover { background:#392b2aff; color:#fff; }
        
        .summary-actions { margin-top:20px; display:flex; flex-direction:column; gap:10px; }
        
        .empty-cart {
            background:#fff; padding:60px 30px; border-radius:12px; text-align:center; border:1px solid #eee;
        }
        .empty-cart h2 { margin:0 0 12px 0; color:var(--accent); }
        ...
        .footer-links a { color:var(--muted); font-size:14px; transition:color 0.2s ease; text-decoration:none; }
        ...
        .modal-content {
            background-color:#fff; margin:15% auto; padding:24px; border-radius:12px; width:90%;
        ...
        @media (max-width: 880px) {
            ...
            .search { display:none; }
            .user-welcome { order:3; width:100%; text-align:center; margin:10px 0 0 0; justify-content:center; }
...
<body>
    ...
    <header class="nav-wrap" role="banner">
        <div class="nav" role="navigation" aria-label="Main navigation">
            <div class="logo" id="brandLink" onclick="window.location.href='finalhomepage.php'">
            ...
            <div class="search" role="search" aria-label="Site search">
                <form method="GET" action="catalog.php" style="display: flex; width: 100%;">
                    <input type="search" name="search" placeholder="Search dresses, designers, collection..." aria-label="Search">
            ...
            <div class="icons" role="group" aria-label="User actions">
                ...
                <a href="cart.php" class="icon-only" title="Shopping Cart" aria-label="Shopping Cart" style="background: rgba(255,255,255,0.1);">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="cart-item">
                            ...
                            <div class="item-details">
                                ...
                                <div class="rental-period">
                                    Rental Period: <?= date('j M Y', strtotime($it['start_date'])) ?> to <?= date('j M Y', strtotime($it['end_date'])) ?>
                                </div>
            ...
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <div class="footer-links">
                        ...
                        <a href="sizingguide.html">Size Guide</a>
                        <a href="policypage.html">Returns & Policy</a>
                ...
                <div>
                    ...
                    <div class="footer-links">
                        ...
                        <a href="cleaning.html">Cleaning & Care Guide</a>
