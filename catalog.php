...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .filter-sidebar.collapsed .filter-toggle-btn .arrow {
...
<body>
    ...
    <script>
        // Filter sidebar collapse functionality
        const filterToggle = document.getElementById('filterToggle');
        const filterSidebar = document.getElementById('filterSidebar');
        
        filterToggle.addEventListener('click', function() {
            filterSidebar.classList.toggle('collapsed');
            this.querySelector('.arrow').textContent = filterSidebar.classList.contains('collapsed') ? '▲' : '▼';
        });
